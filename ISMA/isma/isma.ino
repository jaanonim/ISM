...
String LogValues() {
    return (String)("p1s: " + p1timeS + " p1e: " + p1timeE + " ktime:" + ktime);
}
...
String settimeHtml()
{
  ...
  html += p1timeE;
  html +="\"> </div> <div style=\"clear: both;\"></div> </div> <div class=\"content\"> <div class=\"left\"> <h2>P2:</h2> </div> <div class=\"right\"> <br> </div> <div style=\"clear: both;\"></div> </div> <div class=\"content\"> <div class=\"left\"> <h2>Karmienie:</h2> </div> <div class=\"right\"> <br> <input type=\"time\" name=\"ktime\" value=\"";
  html += ktime;
...
void checkP()
{
  ...
  if (temperatura < 0) {
      ...
      Serial.println("ERROR: Temperature cannot be measured correctly!");
      digitalWrite(led, 0);
      digitalWrite(p2, 1);
      vP2 = false;
  }
  else {
      if (temperatura <= minTemp && !vP2)
      {
          digitalWrite(led, 0);
          digitalWrite(p2, 0);
          vP2 = true;
      ...
      else if (temperatura >= maxTemp && vP2)
      {
          digitalWrite(led, 0);
          digitalWrite(p2, 1);
          vP2 = false;
...
void loop() {
  ...
  Serial.println(" V=" + (String)vcc + " Temp="+ (String)temperatura);
